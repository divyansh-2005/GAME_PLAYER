...
const Footer = () => (
  <div className="bg-purple-900 text-yellow-200 py-4">
    <footer className="container mx-auto px-4">
      <div className="flex justify-between items-center">
        ...
        <div className="flex space-x-4 mr-16">
          ...
          <a href="https://github.com/divyansh-2005/GAME_PLAYER" target="_blank" rel="noopener noreferrer" className="hover:text-yellow-400 transition-colors">
            <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
      ...
      <p className="text-center mt-4">TeleGames &copy; 2024</p>
    </footer>
  </div>
);
