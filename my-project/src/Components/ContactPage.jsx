  ...
  return (
    <div className='contactpage flex flex-col'>
      ...
      <div className="maincard mb-5 bg-white shadow-lg relative shadow-purple-400 rounded-lg w-[70vw] self-center md:h-[calc(95vh-60px)] mt-[5vh]">
        <div className="smallcard m-5 h-[60%] md:h-[80%] md:w-[35%] w-[70%] bg-[#0f3f6f] shadow-2xl justify-around flex p-[2vw] flex-col items-center md:items-start gap-[2vw] absolute md:-left-20 md:top-[10vh] -bottom-[41vh] left-[10vw] shadow-black-300 font-xl">
