...
const AargonAssualt = () => {
  useEffect(() => {
    ...
    const buildUrl = "/Build_AargonAssualt";
    const loaderUrl = `${buildUrl}/Aargon Assault.loader.js`;
    const config = {
      dataUrl: `${buildUrl}/Aargon Assault.data.gz`,
      frameworkUrl: `${buildUrl}/Aargon Assault.framework.js.gz`,
      codeUrl: `${buildUrl}/Aargon Assault.wasm.gz`,
