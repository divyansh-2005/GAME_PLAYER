...
const WordGuessingGame = () => {
  ...
  const [randomWordObject, setRandomWordObject] = useState(() => wordList[Math.floor(Math.random() * wordList.length)]);
  ...
  const resetGame = () => {
    setGuessedLetters([]);
    setWrongGuesses(0);
    const newRandomWordObject = wordList[Math.floor(Math.random() * wordList.length)];
    setRandomWordObject(newRandomWordObject);
    setWord(newRandomWordObject.word);
    setClue(newRandomWordObject.clue);
    setCategory(newRandomWordObject.category);
  };
